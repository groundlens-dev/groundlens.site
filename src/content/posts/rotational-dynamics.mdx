...
The rejection is in the geometry. The model knows more than it says. Reading that reliably from the outside, on a single answer, is a different problem, and a harder one than this paper solves.
